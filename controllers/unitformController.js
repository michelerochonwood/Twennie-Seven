...
prefillFromUpcoming: async (req, res) => {
  try {
    ...
    const mainTopics = [
      ...
      'Designing a Proposal Process','Conducting Color Reviews of Proposals',   'Candid Communication',         'Client Interactions',
            'Cross Selling in Multi-Disciplinary Firms',
            'Analytics in Project Management',
            'Business Development Metrics',
            'Using Lean in Project Management',
            'Turning a Project into a Business Development Powerhouse',
            'Portfolio and Program Management',
            'Making a Proposal Easy to Read, Skim, and Evaluate', 'Storytelling in Technical Marketing',
